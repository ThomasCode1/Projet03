...
if (event.target.files[0]) {
    ...
    let imageWorkUpload = document.createElement("img")
    imageWorkUpload.src = readerEvent.target.result
    imageWorkUpload.alt = event.target.files[0].name
    imageWorkUpload.classList.add("imageWorkUpload")
    document.querySelector(".imageWorkZone").appendChild(imageWorkUpload)
    document.querySelector(".button-photo").style.display = "none"
}
}
})
